<h3>Category: <?php if (!empty($category)) { echo $category; } ?></h3>
...
<article>
	...
	<a class="readMore" href="/articles/<?php if (isset($title)) { echo strtolower(urlencode($title));} ?>"> Read the whole article</a>
